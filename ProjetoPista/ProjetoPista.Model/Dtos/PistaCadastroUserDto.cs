...
namespace ProjetoPista.Model.Dtos
{
	...
	public class PistaCadastroUserDto
	{
		...
		//checkboxes de modalidades estrutura e dificuldades 
		...
		public bool fl_facilmedio { get; set; }
		public bool fl_mediodificil { get; set; }
		public bool fl_alugacapacete { get; set; }
