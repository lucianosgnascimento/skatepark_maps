...
namespace ProjetoPista.Business
{
    public class UsuarioBusiness : IUsuarioBusiness
    {
        ...
        public virtual UsuarioDto VerificaLogin(string Login)
        {
            var usuario = this._unitOfWork
                .UsuarioRepository
                .Get(q => q.Login.ToLower().Equals(Login))
                .FirstOrDefault();
        ...
        public virtual UsuarioDto VerificaEmail(string Email)
        {
            var usuario = this._unitOfWork
                .UsuarioRepository
                .Get(q => q.Email.ToLower().Equals(Email))
                .FirstOrDefault();
